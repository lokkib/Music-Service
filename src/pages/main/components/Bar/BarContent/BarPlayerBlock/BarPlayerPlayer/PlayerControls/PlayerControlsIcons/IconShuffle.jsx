...
export function IconShuffle({ alt }) {
    const shuffleButtonisPressed = useSelector(state => state.orderOfTracksPlaying.shuffleTracks.isButtonPressed)
    ...
    return (
        ...
        >
            <path
                ...
                fill="#696969" stroke={shuffleButtonisPressed ? "#ffffff" : "#696969"}
            />
            <path
                style={themeMode.trackIconsFill2}
