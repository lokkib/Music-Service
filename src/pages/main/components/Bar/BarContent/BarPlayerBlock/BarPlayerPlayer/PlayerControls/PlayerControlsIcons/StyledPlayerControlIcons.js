...
export const PlayerControlIconPrev = ({ alt }) => (
...
const Svg3 = styled(Icon)`
    ...
    stroke: #d9d9d9;
`;
export const PlayerControlIconNext = ({ alt }) => (
...
`;
export const PlayerControlIconRepeat = ({ alt }) => (
...
`;
export const PlayerControlIconShuffle = ({ alt }) => (
