...
const Tracks = () => {
    ...
    return (
        <ThemeContext.Provider  value={{theme2,setTheme2,theme3,setTheme3, theme4, setTheme4, theme5, setTheme5, theme6, setTheme6, theme7, setTheme7, theme8, setTheme8, theme9, setTheme9, theme10, setTheme10}}>
