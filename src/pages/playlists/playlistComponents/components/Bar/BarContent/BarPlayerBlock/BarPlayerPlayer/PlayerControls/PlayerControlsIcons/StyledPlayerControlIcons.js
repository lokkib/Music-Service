...
export function PlayerControlIconPrev ({ alt }) {
    const {theme7} = useContext(ThemeContext);
    const {theme8} = useContext(ThemeContext);
return (
<Svg alt={alt} fill="none" viewBox="0 0 16 14">
        <path style={theme8} d="M1 2V12.5" stroke="white" />
        <path style={theme7} d="M3 7L12.75 0.937823L12.75 13.0622L3 7Z" fill="#D9D9D9" />
    </Svg>
)
    
};

const Svg2 = styled(Icon)`
    width: 22px;
    height: 20px;
    fill: #d9d9d9;
    &:active {
...
`;
export function PlayerControlIconPlay ({ alt }) {
    const {theme7} = useContext(ThemeContext);
  return (
...
const Svg3 = styled(Icon)`
    width: 15px;
    height: 14px;
    
`;
export function PlayerControlIconNext ({ alt }) {
    const {theme7} = useContext(ThemeContext);
    const {theme8} = useContext(ThemeContext);
   return (
<Svg3 alt={alt} fill="none" viewBox="0 0 16 14">
        <path style={theme8} d="M15 2V12.5" stroke="white" />
        <path style={theme7}  d="M13 7L3.25 0.937823L3.25 13.0622L13 7Z" fill="#D9D9D9" />
    </Svg3>
   ) 
};

const Svg4 = styled(Icon)`
    width: 18px;
    height: 12px;
    fill: transparent;
    stroke: #696969;
...
`;
export function PlayerControlIconRepeat  ({ alt }) {
    const {theme9} = useContext(ThemeContext);
   return  <Svg4 alt={alt} fill="none" viewBox="0 0 20 18">
        <path style={theme9}
...
`;
export function PlayerControlIconShuffle ({ alt }) {
    const {theme9} = useContext(ThemeContext);
   return  <Svg5 alt={alt} fill="none" viewBox="0 0 20 18">
        <path  style={theme9}
