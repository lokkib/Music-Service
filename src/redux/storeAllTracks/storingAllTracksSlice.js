...
const storingAllTracks = createSlice({
    ...
    reducers: {
        ...
        toggleChoseAuthors(state, action) {
            ...
            state.finalAuth2 = state.toggledAuthorTracksArray.filter((el) => el[1].chosen === true)
        ...
        toggleChoseGenre(state, action) {
            ...
            state.toggledGenreTracksArray = Object.entries(state.toggledGenreTracks)
            console.log(state.toggledGenreTracksArray);
